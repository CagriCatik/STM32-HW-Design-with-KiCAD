...
Digital-to-Analog Converter. Generates an analog output voltage from a digital value, useful for audio, control signals, or waveform generation.

## DMA

Direct Memory Access. A hardware engine that transfers data between memory and peripherals without CPU involvement, improving throughput and reducing latency.